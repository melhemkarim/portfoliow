...
export default function Home() {
  return (
    ...
    <h1 className="text-center text-5xl pt-6 font-bold " >WEDAD AJEEB</h1>
    <div className="about font-serif text-center tracking-normal ">
      ...
      <a className="pt-10 pb-10 flex justify-center hover:cursor-pointer " href="https://www.instagram.com/wedo_aj?">
      <img
                src="/instagram-logo-fill.svg"  // <-- Path to the image in the public directory
                alt="ig-logo"
                className="  w-16 h-16  " // Set the height as per your design
              />
      </a>
    </div>
    <h1 className="  font-semibold text-5xl pt-6 pb-10 text-center  ">Gallery</h1>
    ...
    <div className="gallery lg:columns-3  sm:flex-row container left-0 mx-auto pb-10">
...
<img
          ...
          />
          <img
            src="/p29.jpg"  // <-- Path to the image in the public directory
            alt="Your Logo"
            className="  p-8" // Set the height as per your design
          />
...
<img
            src="/p8.jpg"  // <-- Path to the image in the public directory
            alt="Your Logo"
            className=" p-8" // Set the height as per your design
          />
          <img
            src="/p10.jpg"  // <-- Path to the image in the public directory
            alt="Your Logo"
            className="  p-8" // Set the height as per your design
          />
          <img
            src="/p28.jpg"  // <-- Path to the image in the public directory
            alt="Your Logo"
            className="  p-8" // Set the height as per your design
          />
